...
<%@ page language="java" contentType="text/html; charset=UTF-8"
			...
			<div id="immersive_slider">
				  <div class="slide" data-blurred="">
						<div class="col-md-6 image">
							<img src="/resources/images/3a.jpg" alt="Slider 1" />
						</div>
				  ...
				  <div class="slide" data-blurred="">
						<div class="col-md-6 image">
							<img src="/resources/images/1a.jpg" alt="Slider 1" />
						</div>
						<div class="col-md-6 content">
	...
	<!-- pricing -->
	<script src="/resources/js/jquery.flipster.js"></script>
	<script>
	<!--
	...
	<!-- //pricing -->
	<!-- slider -->
	<script type="text/javascript" src="/resources/js/jquery.immersive-slider.js"></script>
	<!-- //slider -->
</body>	
</html>